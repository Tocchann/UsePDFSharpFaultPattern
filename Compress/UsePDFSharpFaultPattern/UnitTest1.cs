...
namespace UsePDFSharpFaultPattern
{
	public class UnitTest1
	{
		...
		{
			await ImportPdfAndSaveAsync( "img005.pdf", "Test01_ImportImagePage.pdf" );
		}
		...
		{
			await ImportPdfAndSaveAsync( "Sample32.pdf", "Test02_ImportShiftJisPage.pdf" );
		}
		...
		public async Task Test03_AddFilenameBookmarkAsync()
		{
			...
			string outputDirectory = Path.Combine(baseDirectory, "Output");
			string outputPath = Path.Combine(outputDirectory, "Test03_AddFilenameBookmark.pdf");
		...
		public async Task Test04_AddBookmarkWithPassword1()
		{
			...
			string outputDirectory = Path.Combine(baseDirectory, "Output");
			string outputPath = Path.Combine(outputDirectory, "Test04_AddBookmarkWithPassword.pdf");
		...
		public async Task Test05_AddBookmarkWithPassword2()
		{
			...
			string outputDirectory = Path.Combine(baseDirectory, "Output");
			string outputPath = Path.Combine(outputDirectory, "Test05_AddBookmarkWithPassword.pdf");
